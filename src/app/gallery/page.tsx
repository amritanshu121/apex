...
const Gallery = () => {
  ...
  const galleryImages = [
    ...
    { id: 10, category: "facilities", title: "Waiting Lounge", description: "Comfortable waiting areas for families" },
    {
      id: 11,
      category: "facilities",
      title: "Garden Area",
      description: "Healing garden for patient recovery and relaxation",
    },
    {
      id: 12,
      category: "facilities",
    ...
    },
    {
      ...
      description: "Comprehensive brain and spine treatment facility",
    },
    {
      id: 15,
      category: "departments",
      title: "Oncology Ward",
      description: "Cancer treatment center with chemotherapy unit",
    },
    {
      id: 16,
      category: "departments",
      title: "Pediatrics Wing",
    ...
    },
    {
      ...
      description: "Advanced imaging with MRI, CT, and X-ray",
    },
    {
      id: 20,
      category: "departments",
    ...
    },
    {
      ...
      description: "Kidney care with modern dialysis equipment",
    },
    { id: 23, category: "departments", title: "Eye Care Center", description: "Comprehensive ophthalmology services" },
    { id: 24, category: "departments", title: "Dental Clinic", description: "Complete oral health and dental care" },
    {
      id: 25,
      category: "departments",
    ...
    { id: 27, category: "departments", title: "Psychiatry Wing", description: "Mental health and counseling services" },
    ...
    { id: 30, category: "events", title: "Health Camp", description: "Free health screening camp for community" },
    { id: 31, category: "events", title: "Blood Donation Drive", description: "Community blood donation campaign" },
    {
      id: 32,
      category: "events",
    ...
    { id: 37, category: "staff", title: "Cardiology Team", description: "Expert cardiologists and cardiac surgeons" },
    { id: 38, category: "staff", title: "Nursing Staff", description: "Dedicated nurses providing compassionate care" },
    {
      id: 39,
      category: "staff",
    ...
    { id: 43, category: "staff", title: "Radiology Team", description: "Imaging specialists and technologists" },
    {
      id: 44,
      category: "staff",
    ...
    { id: 45, category: "staff", title: "Pharmacy Team", description: "Qualified pharmacists and medication experts" },
        ...
        <div className={styles.lightbox} onClick={closeLightbox}>
          <div className={styles.lightboxContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.lightboxImage}>
              <Image
                src={`/placeholder.svg?height=600&width=800&text=${encodeURIComponent(currentLightboxImage.title)}`}

        ...
        <div className="container">
          <div className={styles.visionMissionGrid}>
            <div className={styles.visionCard}>
              ...
              <h3>Our Vision</h3>
              <p>
                To be the most trusted healthcare provider in Maharashtra, setting new standards in medical excellence
                and patient care through innovation, compassion, and commitment to healing.
              </p>
            </div>
            <div className={styles.missionCard}>
              ...
              <h3>Our Mission</h3>
              <p>
                To provide world-class healthcare services that are accessible, affordable, and delivered with the
                highest standards of medical expertise, cutting-edge technology, and genuine care for every patient.
              </p>
            </div>
